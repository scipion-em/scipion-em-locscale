...
from os import path
from locscale import __version__
...
setup(
    ...
    name='scipion-em-locscale',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-locscale',  # Optional
    ...
    package_data={  # Optional
       'locscale': ['locscale_logo.jpg', 'protocols.conf'],
    },
